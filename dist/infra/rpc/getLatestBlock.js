...
export const resolveRpcEnvKeys = (chain_id) => CHAIN_RPC_ENV_KEYS[chain_id] ?? [];
export const resolveRpcEnvKey = (chain_id) => resolveRpcEnvKeys(chain_id)[0];
export const resolveRpcUrl = (chain_id) => {
...
export const getLatestBlock = async (chain_id) => {
