...
const buildDeterministicCommentary = (output, insights) => {
    ...
    const scoreSentence = `Score: ${insights.overall_score}/100, Farming risk: ${formatPercent(insights.farming_probability)}.`;
