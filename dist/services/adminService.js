...
import { getAdminSettings, updateOracleEndpoint, updateProtocolParameters } from '../infra/repositories/settingsRepository.js';
export async function fetchAdminSettings() {
    return getAdminSettings();
}
export async function updateAdminParameters(input) {
...
export async function updateAdminOracle(url) {
    if (!/^https?:\/\//i.test(url)) {
