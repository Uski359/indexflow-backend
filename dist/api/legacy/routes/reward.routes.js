...
import { rewardClaimHandler, rewardDistributeHandler, rewardSummaryHandler } from '../controllers/rewardController.js';
...
router.post('/distribute', validateRequest(rewardDistributionSchema), requireAdminWallet, rewardDistributeHandler);
