...
import { campaignCommentaryRequestSchema, campaignInsightsRequestSchema, campaignRunRequestSchema } from '../../schema/usageMockSchema.js';
const router = Router();
...
router.post('/commentary', validateRequest(campaignCommentaryRequestSchema), postCampaignCommentary);
