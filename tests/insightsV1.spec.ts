...
import { computeInsightV1, type InsightV1 } from '../src/insights/insightsV1.js';
  ...
  it('computes campaign insights summary fields', async () => {
    ...
    const outputs = [
      createOutput(
        ...
        { wallet: '0x0000000000000000000000000000000000000001', proof: { hash_algorithm: 'keccak256', canonical_hash: '0x' + '1'.repeat(64) } }
      ),
      createOutput(
        { days_active: 30, tx_count: 60, unique_contracts: 20 },
        { wallet: '0x0000000000000000000000000000000000000002', proof: { hash_algorithm: 'keccak256', canonical_hash: '0x' + '2'.repeat(64) } }
      ),
      createOutput(
        { days_active: 1, tx_count: 120, unique_contracts: 1 },
        { wallet: '0x0000000000000000000000000000000000000003', proof: { hash_algorithm: 'keccak256', canonical_hash: '0x' + '3'.repeat(64) } }
      )
    ];
